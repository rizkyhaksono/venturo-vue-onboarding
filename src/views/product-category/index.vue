      ...
      <BCol lg="12">
        <BCard no-body>
            ...
            <div class="d-flex align-items-center">
              ...
              <div class="flex-shrink-0">
                ...
                <BModal v-model="isOpenForm" size="lg" id="modal-standard" :title="modalTitle" title-class="font-18"
                  ok-title="Simpan" @ok="saveCategory" @hide.prevent
                    ...
                    <BForm>
                      <BRow class="mb-3">
                        ...
                        <BCol md="10">
                          ...
                          }" id="form-name" placeholder="Masukkan Nama Kategori Produk" v-model="formModel.name" />
          ...
          <BCardBody>
                    ...
                    <BTd>
                      <ul class="list-unstyled hstack gap-1 mb-0 justify-content-end">
                        <li data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Edit"
                          ...
                          <BButton class="btn btn-sm btn-soft-info"><i class="mdi mdi-pencil-outline"></i>
                          </BButton>
                        </li>
            ...
            <Pagination :currentPage="productCategoryStore.current" :totalRows="productCategoryStore.totalData"
              :perPage="productCategoryStore.perpage" @update:currentPage="updatePage" />
          </BCardBody>
        </BCard>
      </BCol>
    </BRow>
